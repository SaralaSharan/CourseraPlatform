...
public class ProfessorProfileJPanel extends javax.swing.JPanel {
     ...
     */
    public ProfessorProfileJPanel(Business bz, JPanel jp, String professorID) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Professor Personal Profile");
...
//        String newPassword = new String(txtNewPassword.getPassword());
        UserAccount selecteduseraccount = business.getUserAccountDirectory().findUserAccount(professorID);
        ...
        ArrayList<String> passHistory = professorProfile.getPerson().getPasswordHistory();
